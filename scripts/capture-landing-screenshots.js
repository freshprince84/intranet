...
(async () => {
  ...
  try {
    ...
    try {
      ...
      console.log('Worktracker Screenshot erstellt');
    } catch (err) {
      console.log(`Worktracker Screenshot fehlgeschlagen: ${err.message}`);
    }

    // 4. Consultations Screenshot
    ...
    try {
      ...
      console.log('Consultations Screenshot erstellt');
    } catch (err) {
      console.log(`Consultations Screenshot fehlgeschlagen: ${err.message}`);
    }

    // 5. Team Worktime Control Screenshot
    ...
    try {
      ...
      console.log('Team Worktime Screenshot erstellt');
    } catch (err) {
    ...
    // 7. Document Recognition (Profile/Documents Tab)
    ...
    try {
      ...
      console.log('Document Recognition Screenshot erstellt');
    } catch (err) {
