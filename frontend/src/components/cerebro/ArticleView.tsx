    ...
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
      ...
      <div className="mb-6">
        ...
        {externalLinks.length === 0 ? (
          <p className="text-gray-500 dark:text-gray-400">{t('cerebro.noExternalLinks')}</p>
        ) : (
          <div className="grid grid-cols-1 gap-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="border rounded p-4 dark:border-gray-700">
          <h2 className="text-xl font-bold mb-2 dark:text-white">{t('cerebro.linkedTasks')}</h2>
          <p className="text-gray-500 dark:text-gray-400">{t('cerebro.noLinkedTasks')}</p>
        </div>
        
        <div className="border rounded p-4 dark:border-gray-700">
          <h2 className="text-xl font-bold mb-2 dark:text-white">{t('cerebro.linkedRequests')}</h2>
          <p className="text-gray-500 dark:text-gray-400">{t('cerebro.noLinkedRequests')}</p>
        </div>
      </div>
    </div>
  );
