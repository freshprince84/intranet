...
const ArticleView: React.FC = () => {
  ...
  // ✅ BUTTON-BERECHTIGUNGEN: Korrekte Button-Entitäten verwenden
  const canEditArticle = hasPermission('cerebro_article_edit', 'write', 'button');
  const canDeleteArticle = hasPermission('cerebro_article_delete', 'write', 'button');
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
      ...
      {(canAddMedia || canAddLinks || canEditArticle) && (
