      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 p-6">
        ...
        <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md">
          <p className="text-sm text-yellow-800 dark:text-yellow-300">
            ⚠️ <strong>Hinweis:</strong> Das Template-System ist noch nicht vollständig implementiert. 
            Hochgeladene Templates werden aktuell nicht gespeichert oder verwendet. 
            Dokumente werden mit einer Standard-Vorlage generiert.
          </p>
        </div>
