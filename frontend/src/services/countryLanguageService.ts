 ...
 * 
 * Mappt Länder zu Sprachen für Template-Auswahl basierend auf Reservation.guestNationality
 * 
...
export class CountryLanguageService {
  ...
  /**
   * Bestimmt Sprachcode für Reservation basierend auf guestNationality
   * 
   * Priorität:
