/**
 * Prüft Reservation 18298120 - Warum wird sie nicht importiert?
 */
...
async function checkReservation18298120() {
  console.log('\n🔍 Prüfe Reservation 18298120\n');
  console.log('='.repeat(80));

  const reservationId = '18298120';
