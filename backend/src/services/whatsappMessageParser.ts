...
export interface ParsedReservationMessage {
  propertyName: string;
...
export class WhatsAppMessageParser {
   ...
   */
  static parseReservationMessage(message: string): ParsedReservationMessage | null {
    try {
      ...
      const data: Partial<ParsedReservationMessage> = {};
   ...
   */
  private static parseAmount(amountStr: string): { amount: number; currency: string } {
