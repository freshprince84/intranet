...
export class TTLockService {
  ...
  async createTemporaryPasscode(
    ...
    try {
      ...
      // WICHTIG: keyboardPwd MUSS gesetzt werden (auch für auto)!
      // 10-stellige period Passcodes funktionieren ohne App-Sync (getestet am 13.11.2025)
      // Code 7149923045 war funktionierend
