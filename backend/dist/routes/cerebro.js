...
router.post('/links/fix-github', auth_1.authenticateToken, (0, permissionMiddleware_1.checkPermission)('cerebro_links', 'write', 'cerebro'), cerebroExternalLinksController.fixGitHubLinks);
