...
class EmailReservationParser {
     ...
     */
    static parseReservationEmail(emailText, emailHtml) {
        try {
            // Prüfe ob es eine Reservation-Email ist
            // Unterstützt: Booking.com, Hostelworld, Airbnb
            const isReservationEmail = emailText.includes('nueva reserva') ||
     ...
     */
    static extractReservationCode(text) {
        const patterns = [
...
exports.EmailReservationParser = EmailReservationParser;
//# sourceMappingURL=emailReservationParser.js.map