...
class PromptBuilder {
     ...
     */
    static getBasePrompt(language, aiConfig) {
        let prompt = (aiConfig === null || aiConfig === void 0 ? void 0 : aiConfig.systemPrompt) || 'Du bist ein hilfreicher Assistent.';
        // Füge Regeln hinzu
        if ((aiConfig === null || aiConfig === void 0 ? void 0 : aiConfig.rules) && aiConfig.rules.length > 0) {
            prompt += '\n\nRegeln:\n';
        ...
        if ((aiConfig === null || aiConfig === void 0 ? void 0 : aiConfig.sources) && aiConfig.sources.length > 0) {
     ...
     */
    static getContextInstructions(context, language) {
     ...
     */
    static getFunctionInstructions(functions, language, conversationContext) {
     ...
     */
    static getRoomAvailabilityInstructions(language) {
     ...
     * Tour Instructions
     */
    static getTourInstructions(language) {
     ...
     */
    static getRoomReservationInstructions(language) {
     ...
     */
    static getEmployeeInstructions(language) {
     ...
     */
    static getGeneralFunctionInstructions(language) {
     ...
     */
    static getBookingContextInstructions(language) {
        let prompt = '\n\n=== KRITISCH: KONTEXT-NUTZUNG ===';
     ...
     */
    static getTourContextInstructions(language) {
     ...
     */
    static getChannelSpecificInstructions(channel, language) {
