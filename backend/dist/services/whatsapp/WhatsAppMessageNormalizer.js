...
exports.WhatsAppMessageNormalizer = void 0;
/**
...
class WhatsAppMessageNormalizer {
     ...
     */
    static normalize(message, removeEmojis = false) {
        if (!message)
            return '';
     ...
     * @returns Normalisierte Nachricht
     */
    static normalizeFormatting(message) {
        if (!message)
            return '';
...
exports.WhatsAppMessageNormalizer = WhatsAppMessageNormalizer;
//# sourceMappingURL=WhatsAppMessageNormalizer.js.map