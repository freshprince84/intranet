            ...
            if (this.branchId) {
                ...
                if (branch === null || branch === void 0 ? void 0 : branch.whatsappSettings) {
                    ...
                    try {
                        ...
                        let whatsappSettings = branchSettingsCache.getDecryptedBranchSettings(this.branchId, 'whatsapp', branch.whatsappSettings);
                        ...
                        if (!whatsappSettings) {
                            try {
                                ...
                                const decrypted = decryptApiSettings({ whatsapp: branch.whatsappSettings });
                                whatsappSettings = decrypted === null || decrypted === void 0 ? void 0 : decrypted.whatsapp;
                            }
                            catch (_d) {
                                try {
                                    const { decryptApiSettings } = yield Promise.resolve().then(() => __importStar(require('../utils/encryption')));
                                    whatsappSettings = decryptApiSettings(branch.whatsappSettings);
                                }
                                catch (_e) {
