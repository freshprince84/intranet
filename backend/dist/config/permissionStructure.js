...
exports.getAccessLevelLabel = exports.getAccessLevelOptions = exports.getDefaultPermissionsForRole = exports.getAllEntities = exports.initializePermissions = exports.PERMISSION_STRUCTURE = void 0;
/**
 * KOMPLETTE PERMISSION-STRUKTUR gemäß Plan
 */
exports.PERMISSION_STRUCTURE = [
    // ================== PAGE: Dashboard ==================
    {
        entity: 'dashboard',
        label: 'Dashboard',
 ...
 */
const initializePermissions = (savedPermissions = []) => {
    const allEntities = (0, exports.getAllEntities)();
    const initialized = [];
    allEntities.forEach(({ entity, type }) => {
        // Suche gespeicherten Wert
        const saved = savedPermissions.find(p => p.entity === entity && p.entityType === type);
        // Verwende gespeicherten Wert oder Standard 'none'
        initialized.push({
            entity,
            entityType: type,
            accessLevel: (saved === null || saved === void 0 ? void 0 : saved.accessLevel) || 'none'
        });
    });
    return initialized;
};
...
const getAllEntities = () => {
    const entities = [];
    exports.PERMISSION_STRUCTURE.forEach(page => {
        var _a, _b;
        entities.push({ entity: page.entity, type: 'page', options: page.options });
        (_a = page.boxes) === null || _a === void 0 ? void 0 : _a.forEach(box => {
            var _a, _b;
            if (box.options) {
                entities.push({ entity: box.entity, type: 'box', options: box.options });
            }
            (_a = box.buttons) === null || _a === void 0 ? void 0 : _a.forEach(button => {
                entities.push({ entity: button.entity, type: 'button', options: button.options });
            });
            (_b = box.tabs) === null || _b === void 0 ? void 0 : _b.forEach(tab => {
                var _a;
                entities.push({ entity: tab.entity, type: 'tab', options: tab.options });
                (_a = tab.buttons) === null || _a === void 0 ? void 0 : _a.forEach(button => {
                    entities.push({ entity: button.entity, type: 'button', options: button.options });
                });
            });
        });
        (_b = page.tabs) === null || _b === void 0 ? void 0 : _b.forEach(tab => {
            var _a;
            entities.push({ entity: tab.entity, type: 'tab', options: tab.options });
            (_a = tab.buttons) === null || _a === void 0 ? void 0 : _a.forEach(button => {
                entities.push({ entity: button.entity, type: 'button', options: button.options });
 ...
 */
const getAccessLevelOptions = (options) => {
    if (options === 'binary') {
        return ['none', 'all_both']; // Nein / Ja
    }
    return ['none', 'own_both', 'all_both']; // Nein / Eigene / Alle
};
exports.getAccessLevelOptions = getAccessLevelOptions;
/**
 * Label für AccessLevel
 */
const getAccessLevelLabel = (accessLevel, options) => {
    if (options === 'binary') {
...
exports.getAccessLevelLabel = getAccessLevelLabel;
//# sourceMappingURL=permissionStructure.js.map