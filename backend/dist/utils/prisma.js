...
exports.executeWithRetry = exports.getAllPrismaPools = exports.getPrisma = exports.prisma = exports.releasePoolQuery = void 0;
...
const poolStatuses = prismaPools.map(() => ({
    activeQueries: 0,
    lastUsed: Date.now(),
    totalQueries: 0
}));
...
const releasePoolQuery = (poolIndex) => {
...
exports.releasePoolQuery = releasePoolQuery;
            ...
            return function (...args) {
                ...
                if (result && typeof result.then === 'function') {
                    ...
                    return result.finally(() => {
                        ...
                        (0, exports.releasePoolQuery)(poolIndex);
                    });
                }
                return result;
            };
